...
public:
	...
	void export_point_cloud_recolored(std::string workingDirectory, std::string wD_name, std::vector<cv::Point3d>& point_cloud, std::vector<cv::Vec3b>& point_cloud_colors, std::vector<cv::Point2d>& image_coords_colors, double shifter_x, double shifter_y, double shifter_z) ;
